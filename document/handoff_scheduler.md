...
- Marker thành công: `[stress] wake-before-park PASS`, `[stress] remote-kill PASS` và `[stress] mutex-owner-detach PASS`.
...
- [ ] Thêm regression test kill mutex waiter và concurrent mutex destroy.
