...
3. Extend the SMP regression suite with repeated lock/trylock/unlock versus destroy races, multi-CPU shared-MM detach, suite-level `ALL PASS` aggregation, and deterministic QEMU test exit.
